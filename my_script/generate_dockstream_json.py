...
dockstream_path = os.path.expanduser("/home/cadd/PycharmProjects/DockStream-master")
dockstream_env = os.path.expanduser("/home/cadd/anaconda3/envs/DockStream")
vina_binary_location = os.path.expanduser("/home/cadd/PycharmProjects/DockStream-master/DockStreamCommunity/autodock_vina_1_1_2_linux_x86/bin")
...
ipynb_path = '/home/cadd/PycharmProjects/DockStream-master/DockStreamCommunity'
...
output_dir = os.path.expanduser("/home/cadd/PycharmProjects/DockStream-master/result/Autodock_Vina_demo")
try:
    os.mkdir(output_dir)
      ...
      "embedding_pools": [
        {
          ...
          "type": "RDkit",
          "parameters": {
            "prefix_execution": "module load RDkit"    # only required, if a module needs to be loaded to execute "Corina" or "RDkit"
          },
          "input": {
